...
echo docker build --rm -f "${Dockerfile}"  --network=host --build-arg http_proxy=${http_proxy} --build-arg https_proxy=${https_proxy} -t tdengine/tdengine-${dockername}:${version} "." --build-arg pkgFile=${pkgFile} --build-arg dirName=${dirName} --build-arg cpuType=${cpuTypeAlias}
docker build --rm -f "${Dockerfile}"  --network=host --build-arg http_proxy=${http_proxy} --build-arg https_proxy=${https_proxy} -t tdengine/tdengine-${dockername}:${version} "." --build-arg pkgFile=${pkgFile} --build-arg dirName=${dirName} --build-arg cpuType=${cpuTypeAlias}
